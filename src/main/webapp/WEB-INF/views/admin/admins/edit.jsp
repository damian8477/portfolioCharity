    ...
    <div class="table-content">
        <div class="dashboard-content border-dashed p-3 m-4 view-height">
            ...
            <form:form method="post" modelAttribute="admin">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 label-size col-form-label">Rola</label>
                    <div class="col-sm-10">
                        <form:input path="active" class="form-control"/><form:errors path="active"/>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 label-size col-form-label">Aktywność</label>
                    <div class="col-sm-10">
