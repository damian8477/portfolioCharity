            ...
            <div data-step="1" class="active">
                ...
                <div class="form-group form-group--checkbox">
                    <form:checkboxes path="categories" items="${categories}" itemValue="id" itemLabel="name"
                                     cssClass="custom-checkbox" id="category-input"/>
                </div>
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Kod pocztowy
                                <form:input path="zipCode" id="zip-code"/>
                            </label>
                        </div>
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Numer telefonu
                                <form:input type="phone" path="phone" id="phone"/>
                            </label>
                        </div>
                    </div>
                ...
                <div class="summary">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text">
                                    <label id="quantity-sum"></label>
                                    <label> </label>
                                    <label id="category-sum"></label>
                                </span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary-text">Dla fundacji "<label id="institution-sum"></label>"
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li id="street-sum">Prosta 51</li>
                                <li id="city-sum">Warszawa</li>
                                <li id="zip-code-sum">99-098</li>
                                <li id="phone-sum">123 456 789</li>
                            </ul>
                        </div>
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li id="date-sum">13/12/2018</li>
                                <li id="time-sum">15:40</li>
